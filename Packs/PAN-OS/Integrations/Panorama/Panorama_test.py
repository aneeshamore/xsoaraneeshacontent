...
@patch('Panorama.run_op_command')
def test_pan_os_get_certificate_info_command(patched_run_op_command, template_refreshall, template_stack_refreshall, mocker: MockerFixture, requests_mock: RequestsMock):
    """
